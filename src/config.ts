...
// Gesture snaps (§11): move snaps to a 20px grid, rotate to 15°, skew to 15° (with shift).
export const GRID_SNAP = 20;
// Precision canvas follows Bento/Figma muscle memory: Shift snaps rotation in familiar 15° steps.
