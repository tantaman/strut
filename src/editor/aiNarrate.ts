...
// markdown → sanitized HTML → ProseMirror JSON path every text component and deck import use — so this is
...
/** Append the narrated slides as ONE undoable step: each primary component receives the converted body
 *  Markdown and — when the model gave narration — its `slide_notes`
