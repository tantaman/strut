...
WORKDIR /app
RUN corepack enable && useradd --create-home --uid 10001 slides
...
COPY --chown=slides:slides --from=build /app/package.json /app/pnpm-lock.yaml /app/pnpm-workspace.yaml ./
